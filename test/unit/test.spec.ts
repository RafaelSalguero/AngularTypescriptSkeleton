...
describe("login test", function() {
   ...
   it("inject passes", inject(function($timeout : ng.ITimeoutService) {
        
   }));
   
   it ("correct password passes", inject([ "$q", "$rootScope", "$timeout", function( $q: ng.IQService, $rootScope : ng.IRootScopeService, $timeout : ng.ITimeoutService) {
    //    //Testing a $Q promise
